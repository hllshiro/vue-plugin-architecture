...
- **⚡ importMap机制**: dev和build模式统一支持URL-based插件加载
...
- **项目文档**
  - [架构总览](docs/architecture-overview.md) - 系统架构和工作流程
  - [插件系统](docs/plugin-system.md) - 插件生命周期和状态管理
  - [ImportMap机制](docs/importmap-mechanism.md) - URL-based动态加载详解
  - [Vite插件用法](docs/vite-plugin-usage.md) - 构建工具配置和使用
  - [插件开发指南](docs/plugin-development-guide.md) - 插件开发最佳实践
